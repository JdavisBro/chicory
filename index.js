...
function addMarker(key,locationData,screen,markers,marker,list,yDiff=0,name=null) {
    ...
    listElem.href = "#";
    listElem.innerHTML = name.replaceAll("found_litter_","").replaceAll("gift_","").replaceAll("found_animal_","").replaceAll("_"," ") + "<br>";
