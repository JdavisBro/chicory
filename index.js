...
function addMarker(key,locationData,screen,markers,marker,list,yDiff=0) {
    ...
    listElem.href = "#";
    listElem.innerHTML = key.replaceAll("found_litter_","").replaceAll("gift_","").replaceAll("found_animal_","").replaceAll("_"," ") + "<br>";
